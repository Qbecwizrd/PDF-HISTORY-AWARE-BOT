...
from langchain_core.prompts.chat import MessagesPlaceholder  # ✅ Correct import
...
if api_key:
    llm = ChatGroq(groq_api_key=api_key, model_name='gemma2-9b-it')  # corrected model name spelling
    ...
    if uploaded_files:
        ...
        contextualize_q_prompt = ChatPromptTemplate.from_messages([
            ...
            MessagesPlaceholder(variable_name='chat_history'),  # ✅ Fixed
            ('human', '{input}')
        ])
